...
<body>
    ...
    <script src="{{ asset('trumbowyg/dist/plugins/upload/trumbowyg.cleanpaste.min.js') }}"></script>
    <script src="{{ asset('trumbowyg/dist/plugins/upload/trumbowyg.pasteimage.min.js') }}"></script>
