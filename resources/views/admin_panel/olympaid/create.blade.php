            ...
            <div class="card mb-6">
                <div class="card-body pt-4">
                    <div class="d-flex justify-content-between">
                        <h3>{{ __('messages.create_olympiad') }}</h3>
                    </div>
                    <form id="olympiad_form" action="{{route('olympaid.store')}}" method="POST">
                        @csrf
                        <div class="row g-6">
                            <div class="col-md-6">
                                <label for="name" class="form-label">{{ __('messages.olympiad_name') }}</label>
                                <input class="form-control" type="text" id="name" name="name"
                                    placeholder="{{ __('messages.olympiad_name_placeholder') }}" autofocus />
