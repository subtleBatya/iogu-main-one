            ...
            <div class="card mb-6">
                <div class="card-body pt-4">
                    <div class="d-flex justify-content-between">
                        <h3>{{ __('messages.edit_sport') }}</h3>
                    </div>
                    <form id="sport_form" action="{{route('sport.update', $item->id)}}" method="POST">
                        @csrf
                        @method("PATCH")
                        <div class="row g-6">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="text" id="name" name="name"
                                    placeholder="{{ __('messages.sport_name_placeholder') }}" value="{{ $item->name }}" autofocus />
