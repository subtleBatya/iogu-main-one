...
@section('content')
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            <div>
                                ...
                                <select id="entries" class="form-select form-select-sm d-inline-block w-auto">
                                    <option value="{{ route('users.index', ['entries' => 5]) }}">5</option>
                                    <option value="{{ route('users.index', ['entries' => 25]) }}">25</option>
                                    <option value="{{ route('users.index', ['entries' => 50]) }}">50</option>
                                    <option value="{{ route('users.index', ['entries' => 100]) }}">100</option>
                                </select>
                            ...
                            <tbody id="table-body">
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>{{ Str::limit($item->teachingPlan, 40) }}</td>
                                        <td>
    ...
    <script>
        ...
        entriesSelection.value = "{{ route('users.index', ['entries' => $numOfDataOnPage]) }}";
