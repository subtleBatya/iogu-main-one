...
class PageController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin_panel.page.index', compact('data', 'numOfDataOnPage'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('page.index')->with('success', __('messages.success'));
    }

    public function edit($id)
    {
        $item = About::findOrFail($id);
        return view('admin_panel.page.edit', compact('item'));
    }
