...
class AnnouncementController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin_panel.announcement.index', compact('data', 'numOfDataOnPage'));
    }
    ...
    {
        return view('admin_panel.announcement.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('announcement.index')->with('success', __('messages.success'));
    }

    public function edit($id)
    {
        $item = Notes::findOrFail($id);
        return view('admin_panel.announcement.edit', compact('item'));
    }
